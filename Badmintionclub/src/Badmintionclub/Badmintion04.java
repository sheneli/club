package Badmintionclub;
	...
	public class Badmintion04 {
	  public static void main(String[] args) {
	    ...
	    System.out.println("Several clubs have 18 points");
	    table.stream().filter(Badmintionclub -> Badmintionclub.getPoints() == 18)
	        .forEach(System.out::println);

	    System.out.println();
	    System.out.println("Clubs with 68 points");
	    table.stream().filter(Badmintionclub -> Badmintionclub.getPoints() == 68)
	        .forEach(System.out::println);
