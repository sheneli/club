...
import Badmintionclub.Badmintionclub;


public class Badmintionclub implements Comparable<Badmintionclub> {
	  ...
	  public Badmintionclub(int position, String club, int played, int won, int drawn,
	  ...
	  public int compareTo(Badmintionclub c) {
